...
public class InitBoolean {
    ...
    public static Domains.Object Boolean_prototype_Obj = InitUtils.createInitObj(
            ...
            FHashMap.build(
                    ...
                    Utils.Fields.value, Domains.Bool.inject(Domains.Bool.False)
            )
    );

    public static Domains.Object Boolean_prototype_toString_Obj = InitUtils.unimplemented("Boolean.prototype.toString"); //InitUtils.usualToPrim(any-> any.equals(JSClass.CBoolean), any-> any.b.toStr(), Domains.Str.Bot, any-> Domains.Str.inject((Domains.Str)any), p-> ((Domains.Str)p._1()).merge((Domains.Str)p._2()));

    public static Domains.Object Boolean_prototype_valueOf_Obj = InitUtils.unimplemented("Boolean.prototype.valueOf"); //InitUtils.usualToPrim(any-> any.equals(JSClass.CBoolean), any-> any.b, Domains.Bool.Bot, any-> Domains.Bool.inject((Domains.Bool)any), p-> ((Domains.Bool)p._1()).merge((Domains.Bool)p._2()));
}
